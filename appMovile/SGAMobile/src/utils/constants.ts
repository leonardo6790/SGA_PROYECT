...
export const API_BASE_URL = 'http://172.16.110.159:8080/api'; // Para dispositivo físico y Expo Go
...
export const SERVER_BASE_URL = 'http://172.16.110.159:8080'; // Para dispositivo físico y Expo Go
